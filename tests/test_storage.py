...
def test_storage_client_initialization():
    ...
    client = AzureStorageClient(storage_account="teststorage", container_name="study-materials")
    assert client.storage_account == "teststorage"
    assert client.container_name == "study-materials"
...
def test_storage_upload_download(mock_service_cls):
    ...
    mock_blob.url = "https://teststorage.blob.core.windows.net/study-materials/lecture1.pdf"
    ...
    assert url == "https://teststorage.blob.core.windows.net/study-materials/lecture1.pdf"
