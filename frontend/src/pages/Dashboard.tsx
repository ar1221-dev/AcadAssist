    ...
    <div className="page-stack">
          ...
          <div>
            ...
            <div className="upcoming-list card">
              {upcomingEvents.length ? (
                ...
                <div className="empty-inline">No upcoming events. Add one in Planner.</div>
              )}
            </div>
          </div>
        </section>
      ...
      >
        <p className="text-sm">
          {recommendation ? (
            <>
              Highest priority target: <b>{recommendation.name}</b>. Your upcoming midterm exam is in{' '}
              <b>5 days</b> and your latest score in <b>Deadlocks & Coffman Conditions</b> is 58%. A
              focused 45-minute study session followed by a 10-question practice assessment will provide
              the highest score improvement.
            </>
          ) : (
            <>Add a course from Courses first.</>
          )}
        </p>
        <div className="modal-actions">
          <button
