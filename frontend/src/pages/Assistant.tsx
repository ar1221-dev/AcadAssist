    ...
    <div className="page-stack">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_320px] gap-6">
        ...
        <div>
          ...
          {/* Material Context Banner if provided */}
          {materialId && (
            <div className="flex items-center gap-2 px-3 py-1.5 mb-2 text-xs rounded-lg bg-[var(--color-surface)] border border-[var(--color-border-light)] text-[var(--color-text-muted)]">
              <Database size={13} className="text-[var(--color-green-accent)]" />
              <span>Attached Document: <strong className="text-[var(--color-text-body)]">{materialId}</strong></span>
              <button
                type="button"
                onClick={() => {
                  setMaterialId(null);
                ...
                className="ml-auto text-xs font-bold hover:text-red-500 cursor-pointer"
                title="Detach material context"
              >
                ✕
              </button>
            </div>
