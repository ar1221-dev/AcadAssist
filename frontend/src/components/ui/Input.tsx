...
export default function Input({ label, error, className = '', ...props }: InputProps) {
  return (
    <div className="w-full">
      ...
      <input
        className={`w-full px-3 py-2 border border-[var(--color-card-border)] rounded-lg text-sm bg-white outline-none focus:border-[var(--color-green-accent)] transition-colors ${
