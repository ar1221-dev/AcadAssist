...
class QuestionOut(BaseModel):
    """Public question schema returned during quiz retrieval (hides correct_answer)."""
...
class QuizCreateRequest(BaseModel):
    ...
    count: Optional[int] = Field(default=10, ge=1, le=50, description="Number of questions (default 10)")
