...
class InsufficientQuestionsError(AssessmentError):
    ...
    def __init__(self, requested: int, available: int, topic: str = "general"):
        super().__init__(
            f"Insufficient unique questions available for topic '{topic}'. Requested: {requested}, Available: {available}."
        )
