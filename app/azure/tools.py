"""Microsoft Foundry Agent Tool Definitions and Declarations.

Registers the exact 11 tool contracts for the ONE AcadAssist Agent:
1. search_knowledge
...
Person 1 defines and registers the tool contracts.
Does NOT implement downstream business logic belonging to Persons 2–4.
"""

from typing import Any, Dict, List

# Standard OpenAI / Foundry Function Tool JSON schemas for all 11 tools
FOUNDRY_TOOL_DEFINITIONS: List[Dict[str, Any]] = [
    {
        ...
        "function": {
            ...
            "description": (
                "Search the student's academic knowledge base using hybrid retrieval (BM25 keyword + vector search). "
                "Retrieves relevant course content, lecture notes, textbook passages, and slides."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "user_id": {
                        "type": "string",
                        "description": "The unique UUID of the student user.",
                    },
                    "query": {
                        "type": "string",
                        "description": "The search query or concept to look up in the academic materials.",
                    },
                    "course_id": {
                        "type": ["string", "null"],
                        "description": "Optional UUID filter for a specific course.",
                    },
                    "subject_id": {
                        "type": ["string", "null"],
                        "description": "Optional UUID filter for a specific subject.",
                    },
                    "top_k": {
                        "type": "integer",
