"""Azure AI Search Infrastructure and Index Management.

Defines the acadassist-index schema and configuration for:
- BM25 full-text keyword search
- Vector search (1536 dimensions, Cosine similarity, text-embedding-3-small)
- Hybrid retrieval configuration

Person 1 provides the infrastructure/configuration.
Does NOT implement Person 2's document extraction, chunking, or search_knowledge retrieval logic.
"""
...
def build_acadassist_index_schema(index_name: str = INDEX_NAME) -> SearchIndex:
    """Build the exact 18-field SearchIndex schema for AcadAssist knowledge retrieval.
    ...
    - Metadata filtering by user_id, course_id, subject_id, document_id
    """
    fields: List[SearchField] = [
        # Primary identifier
        SimpleField(name="id", type=SearchFieldDataType.String, key=True),
        # Chunk & user identifiers for filtering
